...
private:
    ...
    bool tileInMiddle(int i);
    bool tileLefttUp(int i);
    bool tileLeftDown(int i);
    bool tileRightUp(int i);
    bool tileRightDown(int i);
    bool tileUpCorner(int i);
    bool tileDownCorner(int i);
